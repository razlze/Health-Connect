...
class PreferencesForm(FlaskForm):
  ...
  facility = SelectField('Facility', choices=[("Ambulatory health care services", "Ambulatory care (including clinics)"), ("Hospitals", "Hospitals"), ("Nursing and residential care facilities", "Nursing & residential"), ("All", "All")], validators=[DataRequired()])
